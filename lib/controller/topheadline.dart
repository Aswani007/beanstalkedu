...
class TopHeadLineService extends GetxController{

  Future<List<Article>> topHeadlineData() async {
    final url = Uri.parse(
        "https://newsapi.org/v2/top-headlines?country=id&apiKey=7c16618422e9461397e1376ec291642c");
